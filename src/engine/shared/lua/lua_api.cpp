...
void register_server_api(lua_State *L)
{
	...
	luabridge::getGlobalNamespace(L)
		...
		.deriveClass<CGameContext, IGameServer>("CGameContext")
			...
			.addFunction("CreateDummy", &CGameContext::CreateDummy)
			.addFunction("CreateEntity", &CGameContext::CreateEntity)
		...
		.beginNamespace("Game")
			...
			.addProperty("Collision", &SLuaState::ms_pCollision, false)
			.addProperty("World", &SLuaState::ms_pWorld, false)
		.endNamespace()
