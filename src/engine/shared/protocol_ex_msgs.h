...
UUID(NETMSG_NUMBER_OF_LUA_FILES, "number-of-lua-files@mmotee.tw")
UUID(NETMSG_LUA_FILE_INFO, "lua-file-info@mmotee.tw")
UUID(NETMSG_LUA_FILE_CHUNK_REQUEST, "lua-file-chunk-request@mmotee.tw")
UUID(NETMSG_LUA_FILE_CHUNK, "lua-file-chunk@mmotee.tw")
UUID(NETMSG_LUA_CUSTOM, "lua-custom@mmotee.tw")
