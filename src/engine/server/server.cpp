...
void CServer::ProcessClientPacket(CNetChunk *pPacket)
{
	...
	if(Sys)
	{
		...
		else if(Msg == NETMSG_INFO)
		{
			...
			{
				static const char *s_pMMONetVer = "0.6 mmoclient";
				...
				bool IsMMOClient = str_comp(pVersion, s_pMMONetVer) == 0;

				if(str_comp(pVersion, GameServer()->NetVersion()) != 0 && str_comp(pVersion, "0.7 802f1be60a05665f") != 0 && !IsMMOClient)
				{
					// wrong version
					char aReason[256];
				...
				m_aClients[ClientID].m_IsMMOClient = IsMMOClient;
