...
class CGameContext : public IGameServer
{
	...
	static void ConLuaReload(IConsole::IResult *pResult, void *pUserData);
...
public:
	...
	bool OnMMOMessage(int MsgID, CUnpacker *pUnpacker, int ClientID);
	void OnMMOTick();
	...
	void SendLuaFileInfo(int ClientID);
	void SendLuaFileChunk(int ClientID, int Chunk);

	static CPlayer *LuaGetPlayer(int ClientID);
};
